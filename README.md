# Amazon-Web-Scrapper
This is a simple Amazon Product Scraper built using scrapy module in python<br/>
...
1. Clone this project  `git clone https://github.com/SWARNABHA1101/Amazon-Web-Scrapper` and cd into it `cd Amazon-Web-Scrapper `
